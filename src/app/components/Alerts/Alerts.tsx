    ...
    <div className="w-full px-4 py-8">
      <div className="max-w-7xl mx-auto mt-28">
        <h1 className="text-3xl font-extrabold text-center mb-8 text-gray-800 dark:text-gray-100">
         Alert, Notification & Banner Components
        </h1>
        <p className="text-center text-gray-600 dark:text-gray-400 mb-12">
          A beautiful collection of 13 alert, notification and banner components built with using Shadcn
          UI and TailwindCSS.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8">
          {components.map(({ id, Component, code }) => (
            <div
              key={id}
              className="p-6 bg-white dark:bg-[#09090b] shadow-md rounded-lg hover:shadow-lg transition-shadow duration-200 border border-gray-300 "
            >
